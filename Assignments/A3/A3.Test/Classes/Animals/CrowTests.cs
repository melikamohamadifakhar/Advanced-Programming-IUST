...
namespace A3Tests.Classes.Animals
{
    ...
    public class CrowTests
    {
        ...
        public void EatFoodTest()
        {
            ...
            // Arrange
            string crow1Expected = $"{crow1.Name} is a Crow and is eating";
            string crow2Expected = $"{crow2.Name} is a Crow and is eating";
            string crow3Expected = $"{crow3.Name} is a Crow and is eating";
            string crow4Expected = $"{crow4.Name} is a Crow and is eating";
