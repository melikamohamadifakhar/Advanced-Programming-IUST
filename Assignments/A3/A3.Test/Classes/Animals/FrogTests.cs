...
namespace A3Tests.Classes.Animals
{
    ...
    public class FrogTests
    {
        ...
        public void MoveTest()
        {
            ...
            string[] expected = new[]
            {
                $"{frog1.Name} is a {typeof(Frog).Name} and can't move in {Enum.GetName(typeof(A3.Enums.Environment), A3.Enums.Environment.Air)} environment",
                $"{frog1.Name} is a {typeof(Frog).Name} and is swimming",
                $"{frog1.Name} is a {typeof(Frog).Name} and is walking",
                $"{frog2.Name} is a {typeof(Frog).Name} and can't move in {Enum.GetName(typeof(A3.Enums.Environment), A3.Enums.Environment.Air)} environment",
            ...
            {
                actual.Add(frog.Move(A3.Enums.Environment.Air));
                actual.Add(frog.Move(A3.Enums.Environment.Watery));
                actual.Add(frog.Move(A3.Enums.Environment.Land));
            }
